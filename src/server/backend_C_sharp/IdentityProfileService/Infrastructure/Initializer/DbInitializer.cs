...
/// <summary>
/// Инициализатор миграций, создающий аккаунты администраторов из Configs/admins.json файла.
/// </summary>
public static class DbInitializer
{
    /// <summary>
    /// Производит миграции, создаёт учетные записи администраторов и роли пользователей.
    /// </summary>
    ...
    /// <summary>
    /// Создаёт записи ролей пользователей.
    /// </summary>
    ...
    /// <summary>
    /// Создаёт записи аккаунтов администраторов.
    /// </summary>
    /// <param name="userManager"></param>
    /// <param name="logger"></param>
    /// <param name="env"></param>
    /// <exception cref="FileNotFoundException"></exception>
    /// <exception cref="AdminsCredentialsEmptyException"></exception>
    private static async Task SeedAdminsAsync(UserManager<Account> userManager, ILogger<AppDbContext> logger, IHostEnvironment env)
    {
        ...
        foreach (var admin in admins)
        {
            ...
            adminAccount.LockoutEnabled = false; // Запрещаем блокировку аккаунта администратора 
